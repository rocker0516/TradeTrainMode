...
class Config:
    ...
    OBS_PRICE_SEQ_1D_TARGET_COLS: tuple[str, ...] = (
        "SOLUSDT_trades_z_short",
        "SOLUSDT_long_short_ratio_z_short",
        "ETHUSDT_volume_log_z",
        "ETHUSDT_sell_volume_z_short",
        "ETHUSDT_rsi_14",
        "ETHUSDT_buy_volume_z_long",
        "ETHUSDT_up_volume_ratio_12",
        "SOLUSDT_volume_ratio_z_long",
        "1000PEPEUSDT_high_roc_12_recent_last",
        "DOGEUSDT_trades_roc_12_full_max",
        "DOGEUSDT_quote_volume_z_long_full_min",
        "1000PEPEUSDT_volume_impact_scale_recent_std",
    )
